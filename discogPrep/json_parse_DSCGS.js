...
fs.readFile('Discogs.json', 'utf8', function(err, data) {
// fs.readFile('package.json', 'utf8', function(err, data) {
	...
	// console.log(obj);
	console.log(obj.discogs[0].about); // Traversing the nested JSON obj
	// console.log(obj.UNPO[1].North_Asia);


	/*	
	for (var a=0; a < obj.discogs.length; a++)
        {
                console.log(obj.discogs[a]);
        }
	*/


	console.log("\n");
        for (var i=0; i < obj.discogs[1].stats.length; i++)
        {
                console.log(obj.discogs[1].stats[i]);
        }
